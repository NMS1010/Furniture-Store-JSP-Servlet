            ...
            <aside class="checkout__sidebar sidebar border-radius-10">
              ...
              <div class="checkout__discount--code">
                <form class="d-flex" action="#">
                  ...
                  <button class="checkout__discount--code__btn primary__btn border-radius-5" onclick="onApplyDiscount()">Áp dụng</button>
                </form>
                ...
                <table class="checkout__total--table">
                  ...
                  <tr class="checkout__total--items">
                    ...
                    <td class="checkout__total--amount text-right">
                      <input value="${totalItemPrice}" name="totalItemPrice" class="primary__btn" size="4" type="text"/>
                    </td>
                  </tr>
                  <tr class="checkout__total--items">
                    <td class="checkout__total--title text-left">Phí vận chuyển</td>
                    <td class="checkout__total--calculated__text text-right">
                      <input value="${shipping}" name="shipping" class="primary__btn" size="4" type="text"/>
                    </td>
                  </tr>
                  <tr class="checkout__total--items">
                    <td class="checkout__total--title text-left">Giảm giá</td>
                    <td class="checkout__total--calculated__text text-right">
                      <input value="${discount}" name="discount" class="primary__btn" size="4" type="text"/>
                    </td>
                  </tr>
                  </tbody>
                  ...
                  <tr class="checkout__total--footer__items">
                    ...
                    <td class="checkout__total--footer__amount checkout__total--footer__list text-right">
                      <input value="${totalPrice}" name="totalPrice" class="primary__btn" size="4" type="text"/>
                    </td>
                  </tr>
                  </tfoot>
                </table>
