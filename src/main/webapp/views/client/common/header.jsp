...
<header class="header__section header__others border-bottom header__transparent mb-30">
          ...
          <ul class="d-flex">
            ...
            <li class="header__account--items">
              <a class="header__account--btn" href="<%=request.getContextPath()%>/wish-list">
                ...
                <span class="items__count wishlist wish_count">${sessionScope.user != null ? sessionScope.user.totalWishListItem : 0}</span>
              </a>
            </li>
            <li class="header__account--items">
              <a class="header__account--btn" href="<%=request.getContextPath()%>/cart/items">
  ...
  <div class="offcanvas__stikcy--toolbar" tabindex="-1">
    <ul class="d-flex justify-content-between">
      ...
      <li class="offcanvas__stikcy--toolbar__list">
        <a class="offcanvas__stikcy--toolbar__btn" href="<%=request.getContextPath()%>/cart/items">
                        <span class="offcanvas__stikcy--toolbar__icon">
