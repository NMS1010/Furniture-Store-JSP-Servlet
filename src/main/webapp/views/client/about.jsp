    ...
    <section class="team__section section--padding">
        <div class="container">
            <div class="section__heading text-center mb-30">
                <h2 class="section__heading--maintitle">Thành viên nhóm</h2>
            </div>
            <div class="team__container">
                <div class="row justify-content-between">
                    <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            <div class="team__thumbnail">
                                <img class="team__thumbnail--img border-radius-50 display-block" src="<%=request.getContextPath()%>/assets/client/img/other/team1.webp" alt="team-thumb">
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            <div class="team__thumbnail">
                                <img class="team__thumbnail--img border-radius-50 display-block" src="<%=request.getContextPath()%>/assets/client/img/other/team2.webp" alt="team-thumb">
                            </div>
                            <div class="team__content">
                                <h3 class="team__content--title">Nguyễn Đức Thành</h3>
                                <span class="team__content--subtitle"></span>
                                <ul class="team__social d-flex justify-content-center align-items-center">
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="https://www.facebook.com/">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            <div class="team__thumbnail">
                                <img class="team__thumbnail--img border-radius-50 display-block" src="<%=request.getContextPath()%>/assets/client/img/other/team3.webp" alt="team-thumb">
                            </div>
                            <div class="team__content">
                                <h3 class="team__content--title">Đỗ Minh Dũng</h3>
                                <span class="team__content--subtitle"></span>
                                <ul class="team__social d-flex justify-content-center align-items-center">
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="https://www.facebook.com/">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            ...
                            <div class="team__content">
                                <h3 class="team__content--title">Đỗ Thị Mỹ Lan</h3>
                                <span class="team__content--subtitle"></span>
                                <ul class="team__social d-flex justify-content-center align-items-center">
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="https://www.facebook.com/">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col-6 custom-col">
                        <div class="team__items text-center">
                            ...
                            <div class="team__content">
                                <h3 class="team__content--title">Lê Anh Nhân</h3>
                                <span class="team__content--subtitle"></span>
                                <ul class="team__social d-flex justify-content-center align-items-center">
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="https://www.facebook.com/">
