...
<jsp:useBean id="categories" type="java.util.ArrayList<view_models.categories.CategoryViewModel>" scope="request"/>
<html>
  <head>
      <meta charset="utf-8" />
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu">
                                    <a class="dropdown-item btn btn-info" href="<%=request.getContextPath()%>/admin/category/edit?categoryId=<c:out value="${category.categoryId}"/>">Sửa</a>
  ...
  <script>
        $(document).ready(function () {
          $('#modal-delete-category').on('show.bs.modal', function (event) {
            ...
            let link = "<%=request.getContextPath()%>/admin/category/delete?categoryId=" + id;
