...
<jsp:useBean id="product" scope="request" class="view_models.products.ProductViewModel"/>
<jsp:useBean id="productReviews" scope="request" type="java.util.ArrayList<view_models.review_items.ReviewItemViewModel>"/>
<html>
<head>
  <meta charset="utf-8" />
