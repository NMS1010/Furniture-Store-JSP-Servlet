                                                    ...
                                                    <div class="product__items--thumbnail">
                                                        ...
                                                        <ul class="product__items--action d-flex justify-content-center">
                                                            <li class="product__items--action__list">
                                                                <a class="product__items--action__btn" onclick="quickView(this)"  data-id="${p}" data-open="modal1" href="javascript:void(0)">
                                                        ...
                                                        <div class="product__list--action">
                                                            ...
                                                            <ul class="product__list--action__wrapper d-flex align-items-center">
                                                                <li class="product__list--action__child">
                                                                    <a class="product__list--action__btn" onclick="quickView(this)"  data-id="${p}" data-open="modal1" href="javascript:void(0)">
